...
const config: Config = {
  ...
  url: 'https://flowc-labs.github.io',
  ...
  organizationName: 'flowc-labs', // Usually your GitHub org/user name.
  projectName: 'flowc-labs.github.io', // Usually your repo name.
