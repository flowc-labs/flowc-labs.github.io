  ...
  return (
    ...
    >
      ...
      <g transform="translate(900, 280) rotate(12)">
        <polygon
          points="0,-37 32,-18.5 32,18.5 0,37 -32,18.5 -32,-18.5"
          fill="none"
          stroke="white"
          strokeWidth="1.6"
          opacity="0.075"
      ...
      <g transform="translate(950, 200) rotate(-15)">
        <polygon
          points="0,-29 25,-14.5 25,14.5 0,29 -25,14.5 -25,-14.5"
          fill="none"
          stroke="white"
          strokeWidth="1.1"
          opacity="0.075"
      ...
      <g transform="translate(350, 240) rotate(48)">
        <polygon
          points="0,-27 23.5,-13.5 23.5,13.5 0,27 -23.5,13.5 -23.5,-13.5"
          fill="white"
          fillOpacity="0.025"
          stroke="white"
          strokeWidth="1"
      ...
      <g transform="translate(750, 230) rotate(-28)">
        <polygon
          points="0,-26.5 23,-13.25 23,13.25 0,26.5 -23,13.25 -23,-13.25"
          fill="none"
          stroke="white"
          strokeWidth="1.3"
          opacity="0.09"
      ...
      <g transform="translate(420, 60) rotate(-35)">
        <polygon
          points="0,-13 11,-6.5 11,6.5 0,13 -11,6.5 -11,-6.5"
          fill="white"
          fillOpacity="0.045"
          stroke="none"
        />
      ...
      <g transform="translate(680, 210) rotate(40)">
        <polygon
          points="0,-13.5 11.7,-6.75 11.7,6.75 0,13.5 -11.7,6.75 -11.7,-6.75"
          fill="white"
          fillOpacity="0.042"
          stroke="none"
        />
    ...
    <header className={clsx("hero", styles.heroBanner)}>
      ...
      <div className="container">
        ...
        <p className={styles.heroSubtitle}>
          flowc is a modern API management control plane that leverages Envoy
          proxy as the runtime gateway. Build, secure, and scale your APIs with
          built-in mediation policies and first-class support for enterprise API
          patterns.
        </p>
      ...
      <div className="container">
        <div className={styles.aboutContent}>
          ...
          <p className={styles.aboutText}>
            flowc is an enterprise-grade API management control plane designed
            from the ground up to provide comprehensive API lifecycle
            management. By leveraging Envoy proxy in the data plane, flowc
            delivers unmatched performance, reliability, and scalability for
            modern API architectures.
          </p>
          <p className={styles.aboutText}>
            With first-class support for widely-used API management patterns,
            flowc provides a rich set of built-in mediation policies that can be
            dynamically added or removed without downtime. For advanced use
            cases, define custom mediation policies tailored to your specific
            requirements.
          </p>
  ...
  const useCases = [
    {
      ...
      description:
        "Implement OAuth2, JWT validation, API key management, and mTLS. Apply rate limiting, threat protection, and WAF policies at the gateway level.",
      icon: "🔒",
    },
    {
      title: "Traffic Management",
      description:
        "Advanced routing, load balancing, circuit breaking, and retry policies. Route based on headers, query parameters, or custom rules.",
      icon: "🚦",
    },
    {
      title: "Transformation & Mediation",
      description:
        "Transform requests and responses on-the-fly. Convert between protocols, modify payloads, and aggregate multiple backend calls.",
      icon: "🔄",
    },
    {
      title: "Observability",
      description:
        "Deep insights into API performance with distributed tracing, metrics, and logs. Integrate with Prometheus, Grafana, and Jaeger.",
      icon: "📊",
    },
  ];
        ...
        <div className={styles.architectureContent}>
          <div className={styles.architectureText}>
            ...
            <ul>
              ...
              <li>Manages multiple Envoy proxy instances</li>
            </ul>
            ...
            <ul>
              ...
              <li>Dynamic mediation policies</li>
            </ul>
          </div>
          <div className={styles.architectureDiagram}>
            ...
            <div className={styles.diagramArrowContainer}>
              <div className={styles.diagramArrow}>↙</div>
              <div className={styles.diagramArrow}>↓</div>
              <div className={styles.diagramArrow}>↘</div>
            </div>
            <div className={styles.dataPlaneContainer}>
              <div className={styles.diagramBox}>
    ...
    <section className={styles.ctaSection}>
      <div className="container">
        ...
        <p className={styles.ctaText}>
          Join the growing community of developers building modern API
          architectures with flowc.
        </p>
        <div className={styles.buttons}>
          <Link className="button button--primary button--lg" to="/docs/intro">
            Get Started Now
